...
* docs: fix some typos [Roddie Hasan]
* spotify: Add option to disable Spotify's audio cache [Roddie Hasan]
* docs: Document SOUND_SPOTIFY_DISABLE_CACHE option [Roddie Hasan]
* spotify: Add option to disable Spotify's audio cache [Roddie Hasan]
